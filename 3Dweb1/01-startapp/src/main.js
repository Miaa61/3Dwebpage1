...
function initScene() {
    //用一张图加载为纹理作为场景背景
    scene.background = new THREE.TextureLoader().load("./texture/picture/sky5.png");
}
initScene();
...
//创建几何体
const geometry0 = new THREE.BoxGeometry(5, 2, 1);
const geometry = new THREE.BoxGeometry(2.5, 1.5, 1);
//创建材质
...
let meshway1,meshway2,meshway3,meshway4,meshway5,meshway6,meshway7,meshway8,meshway9,meshway10;
let meshway11,meshway12,meshway13,meshway14,meshway15,meshway16,meshway17,meshway18,meshway19;
function initFlowingLine() {
    //加载纹理
    flowingLineTexture = new THREE.TextureLoader().load('./texture/picture/arrowhead1.png')

    flowingLineTexture.wrapS = THREE.RepeatWrapping;
    flowingLineTexture.wrapT = THREE.RepeatWrapping;
    flowingLineTexture.repeat.set(1, 1); //水平重复1次
    ...
    let curve6 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(-8.5, 2, 0),
        new THREE.Vector3(-8.5, 0, 0),
        new THREE.Vector3(-3, 0, 0),
    ]);
    let curve7 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(-3, 2, 0),
        new THREE.Vector3(-3, 0, 0),
    ]);
    let curve8 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(-3, 0, 0),
        new THREE.Vector3(-3, -2, 0),
    ]);
    let curve9 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(-3, -2, 0),
        new THREE.Vector3(-3, -4, 0),
    ]);
    let curve10 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(3, 2, 0),
        new THREE.Vector3(3, 0, 0),
    ]);
    let curve11 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(3, 0, 0),
        new THREE.Vector3(3, -2, 0),
    ]);
    let curve12 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(3, 0, 0),
        new THREE.Vector3(1, 0, 0),
        new THREE.Vector3(1, -4, 0),
        new THREE.Vector3(4.5, -4, 0),
    ]);
    let curve13 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(5.5, -2, 0),
        new THREE.Vector3(5.5, 0, 0),
        new THREE.Vector3(3, 0, 0),
    ]);
    let curve14 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(9, 2, 0),
        new THREE.Vector3(9, 0, 0),
    ]);
    let curve15 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(9, 0, 0),
        new THREE.Vector3(9, -2, 0),
    ]);
    let curve16 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(9, 0, 0),
        new THREE.Vector3(6, -2, 0),
    ]);
    let curve17 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(9, 0, 0),
        new THREE.Vector3(12, -2, 0),
    ]);
    let curve18 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(6, -2, 0),
        new THREE.Vector3(4.5, -4, 0),
    ]);
    let curve19 = new THREE.CatmullRomCurve3([
        new THREE.Vector3(6, -2, 0),
        new THREE.Vector3(7.5, -4, 0),
    ]);

    //依据线条路径创建管道几何体
    let tubeGeometry1 = new THREE.TubeGeometry(curve1, 80, 0.1);
    meshway1 = new THREE.Mesh(tubeGeometry1, material);
    meshway1.position.z = 0;

    let tubeGeometry2 = new THREE.TubeGeometry(curve2, 80, 0.1);
    meshway2 = new THREE.Mesh(tubeGeometry2, material);
    meshway2.position.z = 0;

    let tubeGeometry3 = new THREE.TubeGeometry(curve3, 80, 0.1);
    meshway3 = new THREE.Mesh(tubeGeometry3, material);
    meshway3.position.z = 0;

    let tubeGeometry4 = new THREE.TubeGeometry(curve4, 80, 0.1);
    meshway4 = new THREE.Mesh(tubeGeometry4, material);
    meshway4.position.z = 0;

    let tubeGeometry5 = new THREE.TubeGeometry(curve5, 80, 0.1);
    meshway5 = new THREE.Mesh(tubeGeometry5, material);
    meshway5.position.z = 0;

    let tubeGeometry6 = new THREE.TubeGeometry(curve6, 80, 0.1);
    meshway6 = new THREE.Mesh(tubeGeometry6, material);
    meshway6.position.z = 0;

    let tubeGeometry7 = new THREE.TubeGeometry(curve7, 80, 0.1);
    meshway7 = new THREE.Mesh(tubeGeometry7, material);
    meshway7.position.z = 0;

    let tubeGeometry8 = new THREE.TubeGeometry(curve8, 80, 0.1);
    meshway8 = new THREE.Mesh(tubeGeometry8, material);
    meshway8.position.z = 0;

    let tubeGeometry9 = new THREE.TubeGeometry(curve9, 80, 0.1);
    meshway9 = new THREE.Mesh(tubeGeometry9, material);
    meshway9.position.z = 0;
    
    let tubeGeometry10 = new THREE.TubeGeometry(curve10, 80, 0.1);
    meshway10 = new THREE.Mesh(tubeGeometry10, material);
    meshway10.position.z = 0;

    let tubeGeometry11 = new THREE.TubeGeometry(curve11, 80, 0.1);
    meshway11 = new THREE.Mesh(tubeGeometry11, material);
    meshway11.position.z = 0;

    let tubeGeometry12 = new THREE.TubeGeometry(curve12, 80, 0.1);
    meshway12 = new THREE.Mesh(tubeGeometry12, material);
    meshway12.position.z = 0;

    let tubeGeometry13 = new THREE.TubeGeometry(curve13, 80, 0.1);
    meshway13 = new THREE.Mesh(tubeGeometry13, material);
    meshway13.position.z = 0;

    let tubeGeometry14 = new THREE.TubeGeometry(curve14, 80, 0.1);
    meshway14 = new THREE.Mesh(tubeGeometry14, material);
    meshway14.position.z = 0;

    let tubeGeometry15 = new THREE.TubeGeometry(curve15, 80, 0.1);
    meshway15 = new THREE.Mesh(tubeGeometry15, material);
    meshway15.position.z = 0;

    let tubeGeometry16 = new THREE.TubeGeometry(curve16, 80, 0.1);
    meshway16 = new THREE.Mesh(tubeGeometry16, material);
    meshway16.position.z = 0;

    let tubeGeometry17 = new THREE.TubeGeometry(curve17, 80, 0.1);
    meshway17 = new THREE.Mesh(tubeGeometry17, material);
    meshway17.position.z = 0;

    let tubeGeometry18 = new THREE.TubeGeometry(curve18, 80, 0.1);
    meshway18 = new THREE.Mesh(tubeGeometry18, material);
    meshway18.position.z = 0;

    let tubeGeometry19 = new THREE.TubeGeometry(curve19, 80, 0.1);
    meshway19 = new THREE.Mesh(tubeGeometry19, material);
    meshway19.position.z = 0;
}
initFlowingLine();
...
function render() {
    ...
    //arrowLineTexture.offset.x -= 0.005; //更新箭头纹理偏移量
    flowingLineTexture.offset.x -= 0.002; //更新流动线纹理偏移量
...
window.addEventListener("click", (event) => {
    ...
    if (intersects2.length > 0) {
        if (intersects2[0].object._isSelect) {
            scene.remove(meshway2); //设置为false，模型将不会被渲染到场景内
    ...
    if (intersects5.length > 0) {
        if (intersects5[0].object._isSelect) {
            scene.remove(meshway1, meshway2, meshway6, meshway7);
    ...
    if (intersects13.length > 0) {
        ...
        scene.add(meshway1, meshway2, meshway5, meshway7, meshway8, meshway9);
    }

    const intersects14 = raycaster.intersectObjects([cube14]);
    if (intersects14.length > 0) {
        if (intersects14[0].object._isSelect) {
            scene.remove(meshway4, meshway12, meshway14, meshway16, meshway18);
    ...
    if (intersects15.length > 0) {
        ...
        scene.add(meshway4, meshway14, meshway16, meshway19);
    }
...
function createFont() {
    new FontLoader().load("fonts/FangSong_Regular.json", (font) => {
        //console.log(font);
        //参数：字符串+大小
        const shapes = font.generateShapes("ACM竞赛课程地图", 0.48);
        //接收形状
        ...
        let lineMaterial = new THREE.LineBasicMaterial({ color: 0x00d5ff });//0x006699
