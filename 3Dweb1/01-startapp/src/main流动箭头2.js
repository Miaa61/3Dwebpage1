...
function initScene() {
    //用一张图加载为纹理作为场景背景
    scene.background = new THREE.TextureLoader().load("./texture/picture/lb.jpg");
}
initScene();
...
function createFont() {
    new FontLoader().load("fonts/FangSong_Regular.json", (font) => {
        ...
        let lineMaterial = new THREE.LineBasicMaterial({ color: 0xff9500 });//0x006699
